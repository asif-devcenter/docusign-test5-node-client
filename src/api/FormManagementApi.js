...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
	...
	define(['Configuration', 'ApiClient', 'model/HttpError', 'model/WebFormSummaryList'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../Configuration'), require('../ApiClient'), require('../model/HttpError'), require('../model/WebFormSummaryList'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.FormManagementApi = factory(root.Docusign.Configuration, root.Docusign.ApiClient, root.Docusign.HttpError, root.Docusign.WebFormSummaryList);
  }
}(this, function(Configuration, ApiClient, HttpError, WebFormSummaryList) {
  'use strict';
