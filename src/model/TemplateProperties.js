...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Docusign.TemplateProperties = factory(root.Docusign.ApiClient, root.Docusign.Guid);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('originalTemplateId')) {
        obj['originalTemplateId'] = Guid.constructFromObject(data['originalTemplateId']);
      }
      if (data.hasOwnProperty('clonedTemplateId')) {
        obj['clonedTemplateId'] = Guid.constructFromObject(data['clonedTemplateId']);
      }
   ...
   * @member {module:model/Guid} originalTemplateId
   */
   ...
   * @member {module:model/Guid} clonedTemplateId
   */
