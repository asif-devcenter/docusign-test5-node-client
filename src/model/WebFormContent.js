...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BrandId', 'model/IsStandalone', 'model/TemplateProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BrandId'), require('./IsStandalone'), require('./TemplateProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.WebFormContent = factory(root.Docusign.ApiClient, root.Docusign.BrandId, root.Docusign.IsStandalone, root.Docusign.TemplateProperties);
  }
}(this, function(ApiClient, BrandId, IsStandalone, TemplateProperties) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('isStandalone')) {
        obj['isStandalone'] = IsStandalone.constructFromObject(data['isStandalone']);
      }
      if (data.hasOwnProperty('brandId')) {
        obj['brandId'] = BrandId.constructFromObject(data['brandId']);
      }
  ...
  /**
   * @member {module:model/IsStandalone} isStandalone
   */
  exports.prototype['isStandalone'] = undefined;
  /**
   * @member {module:model/BrandId} brandId
   */
