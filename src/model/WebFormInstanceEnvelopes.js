...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EnvelopeId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EnvelopeId'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.WebFormInstanceEnvelopes = factory(root.Docusign.ApiClient, root.Docusign.EnvelopeId);
  }
}(this, function(ApiClient, EnvelopeId) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('id')) {
        obj['id'] = EnvelopeId.constructFromObject(data['id']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/EnvelopeId} id
   */
