...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreatedDateTime', 'model/ExpirationDateTime', 'model/LastModifiedDateTime', 'model/WebFormUserInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CreatedDateTime'), require('./ExpirationDateTime'), require('./LastModifiedDateTime'), require('./WebFormUserInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.WebFormInstanceMetadata = factory(root.Docusign.ApiClient, root.Docusign.CreatedDateTime, root.Docusign.ExpirationDateTime, root.Docusign.LastModifiedDateTime, root.Docusign.WebFormUserInfo);
  }
}(this, function(ApiClient, CreatedDateTime, ExpirationDateTime, LastModifiedDateTime, WebFormUserInfo) {
  'use strict';
   ...
   * @class
   * @param expirationDateTime {module:model/ExpirationDateTime} 
   * @param createdDateTime {module:model/CreatedDateTime} 
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('expirationDateTime')) {
        obj['expirationDateTime'] = ExpirationDateTime.constructFromObject(data['expirationDateTime']);
      }
      if (data.hasOwnProperty('createdDateTime')) {
        obj['createdDateTime'] = CreatedDateTime.constructFromObject(data['createdDateTime']);
      }
      if (data.hasOwnProperty('createdBy')) {
        obj['createdBy'] = WebFormUserInfo.constructFromObject(data['createdBy']);
      }
      if (data.hasOwnProperty('lastModifiedDateTime')) {
        obj['lastModifiedDateTime'] = LastModifiedDateTime.constructFromObject(data['lastModifiedDateTime']);
      }
  ...
  /**
   * @member {module:model/ExpirationDateTime} expirationDateTime
   */
  exports.prototype['expirationDateTime'] = undefined;
  /**
   * @member {module:model/CreatedDateTime} createdDateTime
   */
  ...
  /**
   * @member {module:model/LastModifiedDateTime} lastModifiedDateTime
   */
