...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountId', 'model/WebFormId', 'model/WebFormMetadata', 'model/WebFormProperties', 'model/WebFormState'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccountId'), require('./WebFormId'), require('./WebFormMetadata'), require('./WebFormProperties'), require('./WebFormState'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.WebFormSummary = factory(root.Docusign.ApiClient, root.Docusign.AccountId, root.Docusign.WebFormId, root.Docusign.WebFormMetadata, root.Docusign.WebFormProperties, root.Docusign.WebFormState);
  }
}(this, function(ApiClient, AccountId, WebFormId, WebFormMetadata, WebFormProperties, WebFormState) {
  'use strict';
